{ stdenv, fetchFromGitHub, obs-studio, xorg'libX11, libjpeg_turbo, libusbmuxd, ffmpeg, pkg-config }: stdenv.mkDerivation rec {
  pname = "droidcam-obs";
  version = "1.2.1";
  ...
  buildInputs = [ obs-studio libjpeg_turbo libusbmuxd ffmpeg xorg'libX11 ];
