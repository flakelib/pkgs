...
, fetchFromGitHub
, fetchpatch
, cmake, pkg-config ? null
, libbfd ? null, libGLU ? null, xorg'libX11 ? null
, xorg'libxcb ? null, xorg'libXfixes ? null
, pipewire ? null, glib ? null
, nvidia-capture-sdk ? null
, enableNvfbc ? false
